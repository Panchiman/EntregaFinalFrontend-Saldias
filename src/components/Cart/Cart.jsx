...
const Cart = () => {
    ...
    return (
        <div>
            {cart.length!= 0 ? cart.map((product) => (<div className="CartItems"><img src={product.imagen} alt="" /><h1>{product.nombre}</h1><h2>{"$" + product.precio}</h2></div>)): <h1>No hay productos en el carrito</h1>}
